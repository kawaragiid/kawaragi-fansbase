...
export default function HeroSection() {
  return (
    <section className="relative h-[calc(100vh-64px)] md:h-[calc(100vh-80px)] flex items-center justify-center text-center overflow-hidden animate-fade-in-up">
      {" "}
      {/* Tinggi disesuaikan dengan tinggi navbar */}
      <Image
        src="/kawaragi-hero.png" // Ganti dengan path gambar hero kamu
      ...
      <div className="absolute inset-0 bg-gradient-to-t from-gray-950 via-black/30 to-black/30"></div>
