...
import { getNewsArticles } from "../lib/firebase/firestore"; // <--- JALUR DIPERBAIKI DI SINI
          ...
          <section className="mb-20">
            ...
            >
              <div className="relative w-full md:w-2/5 h-64 md:h-80 overflow-hidden rounded-lg flex-shrink-0">
                <Image src={featuredArticle.imageUrl || "/placeholder.jpg"} alt={featuredArticle.title} layout="fill" objectFit="cover" className="transition-transform duration-500 group-hover:scale-110" priority />
              ...
              <div className="flex-grow flex flex-col justify-between">
                <div>
                  ...
                  <p className="text-gray-400 text-base mb-4">
                    Dipublikasikan: {featuredArticle.date} | Kategori: {featuredArticle.category.join(", ")}
                  </p>
          ...
          {otherArticles.map((article, index) => (
            ...
            >
              <div className="relative w-full md:w-1/3 h-48 md:h-auto overflow-hidden rounded-md flex-shrink-0">
                <Image src={article.imageUrl || "/placeholder.jpg"} alt={article.title} layout="fill" objectFit="cover" className="transition-transform duration-300 group-hover:scale-105" />
              </div>
